...
function addDraftForm(main, a) {
  ...
  const alert = el('div', 'boundary-alert'); const icon = el('i'); icon.setAttribute('data-lucide', 'triangle-alert'); icon.setAttribute('aria-hidden', 'true'); alert.append(icon, el('div', '', t('boundaryReminder'))); draftSection.append(alert);
